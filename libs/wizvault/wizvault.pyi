"""Type stubs for the wizvault native module."""
...
def launch_instance(nickname: str, game_path: str, timeout_secs: int = 30) -> int:
...
def launch_instances(
    nicknames: list[str], game_path: str, timeout_secs: int = 30
) -> dict[str, int]:
...
def import_legacy_vault(vault_path: str, key_path: str) -> int:
